...
- [ ] **[PRIO: mittel] GUI-TEST-P1** P1-Lücken aus Coverage-Audit 2026-09-03 (DoD §3, kein Bug-Fix-Batch): Optics-Renderwirkung restliche 7 Felder + Save/Reopen-Persist, Optics-Labels-Paint, Auto-Optics-ohne-Profil inaktiv, Neighbor-Badges Loading/Stale/Failed, Toast-Rail-Breiten-Invarianz, Grid-Shared-Selection, Duplikat-Pfade, Rect-vs-ROI-Konsistenz, Zoom-Step-Zyklus alle Stufen, Draft-Analyse-Markierung, Portrait-Histogramm, Bildwechsel-Restore; dazu `dismiss_toast` auf `info!` (DoD §4). Abnahme: Tests + unabhängige Verifizierung, `cargo test -p lumina-gui` grün.
