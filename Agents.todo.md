...
- [ ] **[PRIO: mittel] LRPAR-G11-OVERLAYS (Release: 1.0)** Overlay-/Panel-Comfort (G-11, ~60 %): Tool-Overlay-Modi, Edit-Pins-Sichtbarkeit (Always/Auto/Never), Solo-Mode, `Shift+Tab`. Abnahme: GUI-headless.
