...
- `lumina-gui` ist eine native eframe-Desktop-App (WASM/Trunk-Anteil gestrichen
  2026-09-04).
...
- **WASM ENTFERNT 2026-09-04:** Kein Browser-Build; `lumina-onnx` ist eine
  native-only-Crate (spiegelt `lumina-raw`).
...
- **Entscheidung (ADR 0003):** Performance wird mit **Criterion** als
  ...
  (identische Core-Codepfade in `lumina-core`).
