...
/// R5-WARN-2: `DenoiseStageInput` lives in its own submodule so the
/// over-500-line `denoise.rs` keeps its ratchet after the `quiet` field.
mod stage_input;
pub use stage_input::DenoiseStageInput;
